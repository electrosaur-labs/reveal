#!/usr/bin/env node
/**
 * Round-trip test: Read a Lab PSD with @reveal/psd-reader, write it back with @reveal/psd-writer
...
console.log('Step 1: Reading Lab PSD with @reveal/psd-reader...');
...
// Step 2: Write with @reveal/psd-writer using EXACT code from processSP100.js
console.log('Step 2: Writing PSD with @reveal/psd-writer...');
...
if (matches === samples) {
    ...
    console.log(`\n📝 Note: Files created by @reveal/psd-writer use pixel layers, so the`);
